...
class L3outVlanAllocationTestCase(testlib_api.SqlTestCase):
    ...
    def setUp(self):
        ...
        ext_net_dict = {'Management-Out': {'router_id': '1.0.0.2', 
                        ...
                        'Datacenter-Out': {'router_id': '1.0.0.1', 
                                'host_pool_cidr': '10.1.2.1/24', 
                                'port': '1/48', 
                                'switch': '401', 
                                'gateway_ip': '1.103.2.1', 
    ...
    def test_reserve_vlan(self):
        ...
        vlan_id1 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'admin')
        ...
        vlan_id2 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'admin')
        self.assertEqual(vlan_id1, vlan_id2)

        vlan_id3 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'demo')
    ...
    def test_exception_thrown_reserve_vlan_when_full(self):
        vlan_id1 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'test1')
        vlan_id2 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'test2')
        ...
        self.assertRaises(l3out_vlan_alloc.NoVlanAvailable,
                          ...
                          'Management-Out', 'test3')

        self.l3out_vlan_alloc.release_vlan('Management-Out', 'test1')
        vlan_id5 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'test3')
        self.assertEqual(vlan_id1, vlan_id5)

        # test when the vlan pool is full again with different vrf
        self.assertRaises(l3out_vlan_alloc.NoVlanAvailable,
                          self.l3out_vlan_alloc.reserve_vlan,
                          'Management-Out', 'test1')
    ...
    def test_no_exception_thrown_release_no_vlan(self):
        vlan_id1 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'test1')
        self.l3out_vlan_alloc.release_vlan('Management-Out', 'garbage')    

    def test_get_vlan_allocated(self):
        vlan_id1 = self.l3out_vlan_alloc.reserve_vlan('Management-Out', 'test')
        LOG.info(("vlan reserved: %d"), vlan_id1)
    ...
    def test_no_range_no_exception(self):
        ext_net_dict = {'NoRange-Out': {'router_id': '1.0.0.1',
                                'cidr_exposed': '1.103.2.254/24'}
                       }
